...
- **Módulo C (sector salud)**: solo aparece en los datos si la institución activó "sector salud". Si aparece, interpreta C1/C2/C3 como **deberes reforzados del sector** con su anclaje (`referencias.md` §1 y §3) —C1 es crítica— y léelos junto a su base genérica (A4/A8, B9/A6, B7/A7/A12). Si **no** aparece, es lo esperado en una institución no-salud: **no lo reportes como brecha ni lo eches en falta**.
